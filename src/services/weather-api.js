 ...
 */
export const getWeatherIconSVG = (main) => {
  const icons = {
    Clear: `
      <svg viewBox="0 0 80 80" fill="none" stroke="#b0b8d0" stroke-width="2.5" stroke-linecap="round">
    ...
    `,
    Clouds: `
      <svg viewBox="0 0 40 40" fill="none" stroke="#7a8db0" stroke-width="1.8" stroke-linecap="round">
    ...
    Snow: `
      <svg viewBox="0 0 40 40" fill="none" stroke="#7a8db0" stroke-width="1.8" stroke-linecap="round">
        <path d="M8 20 Q14 16 20 20 Q26 24 32 20" />
        <path d="M8 26 Q14 22 20 26 Q26 30 32 26" />
        <path d="M10 14 Q16 10 22 14 Q28 18 34 14" />
      </svg>
    `,
  };
